...
import '../logic/search/search.dart';
import '../logic/search/searchState.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    final state = context.watch(searchRef);
    ...
    return Scaffold(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  onChanged: (String icerik) {
                    context.use(searchLogicRef).searchFetched(icerik);
                  },
                ),
              ),
              Expanded(
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            context.use(searchLogicRef).searchStateReset();
          },
        ),
      ),
    );
