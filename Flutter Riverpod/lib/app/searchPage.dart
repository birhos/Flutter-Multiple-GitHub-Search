...
import '../stateNotifier/search/search.dart';
import '../stateNotifier/search/searchState.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (BuildContext context, watch, Widget? child) {
        final state = watch(searchProvider);
        ...
        return Scaffold(
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (String icerik) {
                        context.read(searchProvider.notifier).searchFetched(icerik);
                      },
                    ),
                  ),
                  Expanded(
          ...
          floatingActionButton: SizedBox(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                context.read(searchProvider.notifier).searchStateReset();
              },
            ),
          ),
        );
